...
- `pages/knowledge`：外贸知识点新页面，用于替代课程页悬浮知识点按钮的旧 PDF 图片入口；页面按 Web 版知识点层级展示场景背景、词汇和句型、Chinglish Correction、毅冰补充和对话原文，分区标题只显示中文。对话原文按句号、问号、感叹号等句末标点拆成短段，同一说话人保持同一段落颜色，不同说话人要有明显色彩区分。
