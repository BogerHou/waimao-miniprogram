...
exports.selectCoachLearningScene = selectCoachLearningScene;
exports.flattenAvailableScenes = flattenAvailableScenes;
function selectCoachLearningScene({ chapters, progress, sessions, plannedSceneIds, }) {
    ...
    if (resumableSession) {
        ...
        if (selected)
            return { ...selected, session: resumableSession, source: 'resume' };
    }
...
function flattenAvailableScenes(chapters) {
