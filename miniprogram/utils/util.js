...
exports.formatEntitlementExpiry = formatEntitlementExpiry;
exports.formatInviteErrorMessage = formatInviteErrorMessage;
...
function formatEntitlementExpiry(expiresAt) {
...
function formatInviteErrorMessage(error) {
